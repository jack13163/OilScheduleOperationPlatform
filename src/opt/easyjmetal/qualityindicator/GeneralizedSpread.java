...
import opt.easyjmetal.qualityindicator.util.LexicoGraphicalComparator;
import opt.easyjmetal.qualityindicator.util.MetricsUtil;
import opt.easyjmetal.qualityindicator.util.ValueComparator;
...
public class GeneralizedSpread {
  ...
  public static MetricsUtil utils_;  // MetricsUtil provides some
