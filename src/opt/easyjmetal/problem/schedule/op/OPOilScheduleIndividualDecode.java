...
import opt.easyjmetal.problem.schedule.cop.OilScheduleConstrainedOptimizationProblem;
import opt.easyjmetal.problem.schedule.operation.Operation;
import opt.easyjmetal.problem.schedule.util.CSVHelper;
...
public class OPOilScheduleIndividualDecode {
    ...
    public static void decode(String path, int row, String ruleName) {
        ...
        // 解码
        Solution solution = getDoubleSolution(content, ruleName);
     ...
     * @return
     */
    private static double[] decode(Solution solution, String ruleName) {
     ...
     * @return
     */
    private static Solution getDoubleSolution(String[] solutioncode, String ruleName) {
        Solution solution = new Solution(new OilScheduleConstrainedOptimizationProblem(ruleName));
