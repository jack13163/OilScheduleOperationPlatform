...
import opt.easyjmetal.util.comparators.AtmDominanceComparator;
...
public class ATMRanking {
     ...
     */
    private static final Comparator dominance_ = new AtmDominanceComparator();
