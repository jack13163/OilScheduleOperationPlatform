...
public class NSGAII_CDP_Fitness_Contribution extends Algorithm {

    private SolutionSet population_;
    private SolutionSet external_archive_;
    private String dataDirectory_;

    public NSGAII_CDP_Fitness_Contribution(Problem problem) {
        super(problem);
    }
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        String tableName = "NSGAII_CDP_Fitness_Contribution_" + runningTime;
        ...
        while (evaluations_ < maxEvaluations_) {
            ...
            if (remain > 0) {
                ...
                if (Math.random() < iterationRate) {
                    ...
                    Contribution.calculateHVContribution(remainSolutions);
                    remainSolutions.sort(new ContributionComparator());
                } else {
