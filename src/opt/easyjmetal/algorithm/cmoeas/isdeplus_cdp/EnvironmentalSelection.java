...
import opt.easyjmetal.algorithm.cmoeas.util.FitnessComparator;
...
public class EnvironmentalSelection {
    ...
    public SolutionSet execute(SolutionSet source2) {
        // 计算适应度值
        this.isdePlus_fitness.computeFitnessValue(source2);
        ...
        // 获取所有个体的不同的两两组合
        double[][] distance = aux.writeObjectivesToMatrix();
