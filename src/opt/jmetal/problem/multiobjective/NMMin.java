...
import opt.jmetal.problem.impl.AbstractIntegerProblem;

/**
 * Created by Antonio J. Nebro on 03/07/14. Bi-objective problem for testing
 * integer encoding. Objective 1: minimizing the distance to value N Objective
 * 2: minimizing the distance to value M
 */
