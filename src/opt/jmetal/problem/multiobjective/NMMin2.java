...
import opt.jmetal.problem.impl.AbstractIntegerDoubleProblem;

/**
 * Created by Antonio J. Nebro on 18/09/14. Bi-objective problem for testing
 * integer/double encoding. Objective 1: minimizing the distance to value N
...
public class NMMin2 extends AbstractIntegerDoubleProblem<IntegerDoubleSolution> {
     ...
     * Constructor
     */
    public NMMin2(int numberOfIntegerVariables, int numberOfDoubleVariables, int n, int m, int lowerBound,
                  int upperBound) {
    ...
    public void evaluate(IntegerDoubleSolution solution) {
        ...
        for (int i = solution.getNumberOfIntegerVariables(); i < (solution.getNumberOfIntegerVariables()
                + solution.getNumberOfDoubleVariables()); i++) {
