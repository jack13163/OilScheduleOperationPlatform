...
import opt.jmetal.util.pseudorandom.impl.ExtendedPseudoRandomGenerator;
...
public class StandardPSO2011 extends AbstractParticleSwarmOptimization<DoubleSolution, DoubleSolution> {
    ...
    public void updateVelocity(List<DoubleSolution> swarm) {
        ...
        for (int i = 0; i < swarmSize; i++) {
            ...
            double[] random = ((ExtendedPseudoRandomGenerator) randomGenerator.getRandomGenerator())
                    .randSphere(problem.getNumberOfVariables());
