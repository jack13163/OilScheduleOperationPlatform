...
package opt.jmetal.algorithm.multiobjective.cdg;
...
import opt.jmetal.operator.impl.mutation.CDGMutation;
import opt.jmetal.problem.Problem;
import opt.jmetal.solution.DoubleSolution;

/**
 * Xinye Cai, Zhiwei Mei, Zhun Fan, Qingfu Zhang, A Constrained Decomposition
 * Approach with Grids for Evolutionary Multiobjective Optimization, IEEE
 * Transaction on Evolutionary Computation, press online, 2018, DOI:
 * 10.1109/TEVC.2017.2744674 The paper and Matlab code can be download at
