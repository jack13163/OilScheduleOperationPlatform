package opt.jmetal.algorithm.multiobjective.mochc;
 ...
 * 2007.
 * <p>
 * Implementation of MOCHC following the scheme used in jMetal4.5 and former
...
public class MOCHC45 implements Algorithm<List<BinarySolution>> {
    ...
    public MOCHC45(BinaryProblem problem, int populationSize, int maxEvaluations, int convergenceValue,
                   ...
                   CrossoverOperator<BinarySolution> crossoverOperator, MutationOperator<BinarySolution> cataclysmicMutation,
    ...
    private int hammingDistance(BinarySet bitSet1, BinarySet bitSet2) {
        if (bitSet1.getBinarySetLength() != bitSet2.getBinarySetLength()) {
            throw new JMetalException("The bitsets have different length: " + bitSet1.getBinarySetLength() + ", "
                    + bitSet2.getBinarySetLength());
        }
        int distance = 0;
        int i = 0;
