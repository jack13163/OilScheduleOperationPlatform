...
import opt.jmetal.algorithm.impl.AbstractDifferentialEvolution;
...
public class GDE3 extends AbstractDifferentialEvolution<List<DoubleSolution>> {
     ...
     * Constructor
     */
    public GDE3(DoubleProblem problem, int populationSize, int maxEvaluations, DifferentialEvolutionSelection selection,
                DifferentialEvolutionCrossover crossover, SolutionListEvaluator<DoubleSolution> evaluator) {
        setProblem(problem);
