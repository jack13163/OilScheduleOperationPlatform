package opt.jmetal.qualityindicator.impl.hypervolume;
...
import opt.jmetal.util.solutionattribute.impl.HypervolumeContributionAttribute;
    ...
    public Double evaluate(List<S> solutionList) {
        ...
        if (solutionList.size() == 0) {
            ...
            if (numberOfObjectives == 2) {
                ...
                updateReferencePoint(solutionList);
                //设置参考点坐标为（1，1，1，1，1）
                WfgHypervolumeVersion wfgHv = new WfgHypervolumeVersion(numberOfObjectives, solutionList.size(), new ArrayPoint(new double[]{1, 1, 1, 1, 1}));
