...
import org.uma.jmetal.encodings.solutiontype.variable.Binary;
import org.uma.jmetal.encodings.solutiontype.variable.BinaryReal;
...
public class Solution implements Serializable {
	...
	public double getConstraint(int i){return  constraint_[i];} // getConstraint
    ...
    public int isDominated(Solution solution){
        ...
        if(more_than == 0 && less_than != 0) return 1;

        if(less_than == 0 && more_than != 0) return -1;
