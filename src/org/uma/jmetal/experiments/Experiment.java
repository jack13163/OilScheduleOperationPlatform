...
import org.uma.jmetal.experiments.util.RBoxplot;
import org.uma.jmetal.experiments.util.RWilcoxon;
import org.uma.jmetal.experiments.util.RunExperiment;
import org.uma.jmetal.experiments.util.Statistics;
...
public abstract class Experiment {
    ...
    public synchronized int[] getNextProblem() {
        ...
        if (problemIndex < this.problemList_.length - 1) {
            ...
            if (algorithmIndex < this.algorithmNameList_.length - 1) {
                algorithmIndex++;
                problemIndex = 0;
            } else {
                if (irunIndex < this.independentRuns_ - 1) {
                    irunIndex++;
                    problemIndex = 0;
                    algorithmIndex = 0;
                } else {
