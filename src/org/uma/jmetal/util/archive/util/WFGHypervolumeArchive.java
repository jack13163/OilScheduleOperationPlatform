...
package org.uma.jmetal.util.archive.util;
...
public class WFGHypervolumeArchive extends Archive {
  ...
  public WFGHypervolumeArchive(int maxSize, int numberOfObjectives) {
    ...
    dominance_        = new ViolationThresholdComparator.DominanceComparator();
    equals_           = new EqualSolutions();
    distance_         = new Distance();
    utils_            = new MetricsUtil() ;
    offset_           = 100 ;
    crowdingDistance_ = new ViolationThresholdComparator.CrowdingDistanceComparator();
