...
import org.uma.jmetal.util.comparator.AtmObjectiveComparator;
import org.uma.jmetal.util.comparator.IdeaObjectiveComparator;
...
public class Distance {
  ...
  public void crowdingDistanceAssignment(SolutionSet solutionSet, int nObjs) {
    ...
    for (int i = 0; i<nObjs; i++) {
      ...
      front.sort(new ViolationThresholdComparator.ObjectiveComparator(i));
