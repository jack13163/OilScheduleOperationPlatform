...
public class Spea2Fitness {
   ...
   */
  private static final Comparator dominance_ = new ViolationThresholdComparator.DominanceComparator();
  ...
  */
  public SolutionSet environmentalSelection(int size){        
    ...
    if (aux.size() < size){
      Comparator comparator = new ViolationThresholdComparator.FitnessComparator();
