...
public class SimulationEntity extends SimulationProcess {
	 ...
	 * @param immediate
	 *            specify whether immediate resumption is required.
	 ...
	 * @throws RestartException
	 *             thrown if the simulation has been restarted.
	 * @throws InterruptedException
	 *             thrown if this instance has been interrupted.
	 */
	 ...
	 * 
	 * @param controller
	 *            the process upon whose termination this instance will be
	 *            resumed.
	 * @param reAct
	 *            indicate whether or not the controlling process should be
	 *            activated now.
	 * @throws SimulationException
	 *             thrown if an error occurs.
	 * @throws RestartException
	 ...
	 * 
	 * @param _queue
	 *            the queue to place this process.
	 * @throws SimulationException
	 *             thrown if an error occurs.
	 * @throws RestartException
	 *             thrown if the simulation has been restarted.
